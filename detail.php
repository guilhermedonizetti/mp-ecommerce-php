...
<body class="as-theme-light-heroimage">
    ...
    <div class="stack">
                            ...
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <div class="botao_pagamento">
                                        <!-- botao de pagamento vem aqui (criado pelo JS) -->
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            const mp = new MercadoPago('APP_USR-a2a9c127-082a-4278-9835-006f88b13a89', {
                locale: 'pt-BR'
            });
